...
## Candidate notes:
We want you to implement a standard web page, regarding the above Layout Specification section and the wireframes provided on the repository root folder.
Feel free to edit layout and decorate it as you want. Animations are welcome too.
